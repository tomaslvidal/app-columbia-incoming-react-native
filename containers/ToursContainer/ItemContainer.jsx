    ...
    return (
        <View>
          <View style={{ marginLeft: -20, marginRight: -20 }}>
            ...
            }} indicator={Progress} source={{uri: this.state.item.image1}} style={[styles.footerImage]} />
          </View>

          <View style={styles.box}>
            <Text style={styles.textTitle}>{this.state.item.title}</Text>

              <HTML html={this.state.item.description!=undefined ? this.state.item.description : ''} alterChildren = { node => {
                        if(node.name === 'p'){
