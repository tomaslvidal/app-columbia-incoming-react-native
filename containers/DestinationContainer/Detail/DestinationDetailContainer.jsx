    ...
    return (
      <Div ref={(ref) => this.div = ref} name="Formulario de Reclamos" icon="wpforms">
        <View onLayout={(e) => this._setMaxHeight(e)}>
          ...
          <Image
              source={{uri: 'https://maps.googleapis.com/maps/api/staticmap?center=25.77276+-80.19231&zoom=15&language=es-419&size=293x190&maptype=roadmap&key=AIzaSyCnQU5LBRcxeVdmmOdGGZ7a_paVz7wGy1E&markers=size:mid%7Ccolor:0xff0000%7Clabel:%7C25.77276+-80.19231'}}
              style={{
                  width: 300,
                  height: 400
              }}
            ...
            }} indicator={Progress} resizeMethod="resize" 
            />
